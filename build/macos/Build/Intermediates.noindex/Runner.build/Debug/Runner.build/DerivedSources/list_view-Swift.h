...
#ifndef LIST_VIEW_SWIFT_H
#define LIST_VIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="list_view",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9list_view11AppDelegate")
...
SWIFT_CLASS("_TtC9list_view17MainFlutterWindow")
